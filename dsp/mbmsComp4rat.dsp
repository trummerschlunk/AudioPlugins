...
with {
  ...
  strength_array = ratio2strength(vslider("v:master_me/h:[5]mscomp/h:[5]low band/[1][symbol:mscomp_low_ratio]low ratio", 2, 1, 8, 0.1)),ratio2strength(vslider("v:master_me/h:[5]mscomp/h:[6]high band/[1][symbol:mscomp_high_ratio]high ratio", 2, 1, 8, 0.1)):LinArray(B);
